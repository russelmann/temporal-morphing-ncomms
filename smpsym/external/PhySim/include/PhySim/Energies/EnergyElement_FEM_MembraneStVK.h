...
namespace PhySim
{
	...
	class EnergyElement_FEM_MembraneStVK : public EnergyElement_FEM
	{

	public:
		EnergyElement_FEM_MembraneStVK(Model_Particles* pModel, Face* pFace, Material* pMaterial, int numQ = 1) : EnergyElement_FEM(pModel, pFace, pMaterial, numQ)
		{
			// Nothing to do here...
		}

		virtual ~EnergyElement_FEM_MembraneStVK(void)
		{
			// Nothing to do here...
		}
...
#include "../codegen/FEMMem_StVK_Energy.mcg"
...
#include "../codegen/FEMMem_StVK_Gradient.mcg"
...
#include "../codegen/FEMMem_StVK_Hessian.mcg"
