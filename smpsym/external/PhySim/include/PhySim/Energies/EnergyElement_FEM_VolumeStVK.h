...
namespace PhySim
{
	...
	class EnergyElement_FEM_VolumeStVK : public EnergyElement_FEM
	{

	public:
		EnergyElement_FEM_VolumeStVK(Model_Particles* pModel, Cell* pCell, Material* pMaterial, int numQ = 1) : EnergyElement_FEM(pModel, pCell, pMaterial, numQ)
		{
			// Nothing to do here...
		}

		virtual ~EnergyElement_FEM_VolumeStVK(void)
		{
			// Nothing to do here...
		}
...
#include "../codegen/FEMVol_StVK_Energy.mcg"
...
#include "../codegen/FEMVol_StVK_Gradient.mcg"
...
#include "../codegen/FEMVol_StVK_Hessian.mcg"
