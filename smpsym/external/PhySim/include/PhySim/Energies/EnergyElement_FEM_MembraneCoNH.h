...
namespace PhySim
{
	...
	class EnergyElement_FEM_MembraneCoNH : public EnergyElement_FEM
	{

	public:
		EnergyElement_FEM_MembraneCoNH(Model_Particles* pModel, Face* pFace, Material* pMaterial, int numQ = 1) : EnergyElement_FEM(pModel, pFace, pMaterial, numQ)
		{
			// Nothing to do here...
		}

		virtual ~EnergyElement_FEM_MembraneCoNH(void)
		{
			// Nothing to do here...
		}
...
#include "../codegen/FEMMem_CoNH_Energy.mcg"
...
#include "../codegen/FEMMem_CoNH_Gradient.mcg"
...
#include "../codegen/FEMMem_CoNH_Hessian.mcg"
