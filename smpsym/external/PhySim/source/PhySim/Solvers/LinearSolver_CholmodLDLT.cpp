...
namespace PhySim
{
	...
	LinearSolver_CholmodLDLT::LinearSolver_CholmodLDLT(const MatrixSd& mA, const LinearSolverOptions& options) : LinearSolver(mA, options)
	{
	...
	void LinearSolver_CholmodLDLT::Init(const MatrixSd& mA, const LinearSolverOptions& options)
	{
	...
	SolveResult LinearSolver_CholmodLDLT::SolveInternal(MatrixSd& mA, const VectorXd& vb, VectorXd& vx)
	{
		int N = (int) mA.rows();
		int M = (int) mA.cols();
	...
	SolveResult LinearSolver_CholmodLDLT::SolveInternal(MatrixSd& mA, const MatrixXd& mB, MatrixXd& mX)
	{
	...
	SolveResult LinearSolver_CholmodLDLT::SolveInternal(MatrixSd& mA, const MatrixSd& mB, MatrixSd& mX)
	{
		throw new exception("Not implemented");
	...
	//SolveResult LinearSolver_CholmodLDLT::Solve_CG(MatrixSd& mA, const VectorXd& vb, VectorXd& vx)
	//{
	//	int N;
	//	Real normA;
	//	MatrixSd mR;
	...
	//SolveResult LinearSolver_CholmodLDLT::Solve_LU(MatrixSd& mA, const VectorXd& vb, VectorXd& vx)
	//{
	//	int N;
	//	Real normA;
	//	MatrixSd mR;
